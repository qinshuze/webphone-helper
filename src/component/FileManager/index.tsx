...
function FileType(props: { file: RemoteFile }) {
    ...
    if (["jpg", "jpeg", "png", "gif"].includes(type)) {
        return <Image
            ...
            src={`https://gips0.baidu.com/it/u=398917425,2942293409&fm=3028&app=3028&f=JPEG&fmt=auto?w=1920&h=2560`}
...
export default function FileManager(props: FileManagerProps) {
    ...
    console.log(fileNavigationTree, fileNavigationTreeMap)

    useEffect(() => {
        setSkeletonLoading(true)
        getRemoteFiles(rootPath).then(dataList => {
            console.log({...rootNode, children: dataList})
